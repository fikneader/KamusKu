...
public class DefinitionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (bundle == null){
            ...
            final TextView kataText = (TextView) view.findViewById(R.id.kataText);
            final TextView pengertianText = (TextView) view.findViewById(R.id.pengertianText);
            ImageView gambarPengertian = (ImageView) view.findViewById(R.id.imageDef);
